...
class VagonPasajeros extends Vagon{
    ...
    //METODO CONSTRUCTOR
        public function __construct($anioInstalacion,$largoVagon,$anchoVagon,$pesoVagonVacio,$cantPasajerosTransportando, $cantMaximaPasajerosTransportando) {
...
public function __toString()
{
    ...
    $cadena .= "\nPeso total del vagón (con pasajeros): " . $this->getPesoVagonVacio() . " kg";
    return $cadena;
}
